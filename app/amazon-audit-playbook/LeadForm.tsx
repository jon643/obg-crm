...
const THANK_YOU_PATH = '/amazon-audit-playbook/thank-you'

interface LeadFormProps {
  /** Attributes which form on the page submitted the lead (forwarded to /api/lead). */
  location?: string
}
